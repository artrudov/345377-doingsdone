<div class="modal" id="task_add" <?= count($errors) ? '' : 'hidden'?>>
    ...
    <form class="form" action="index.php" method="post" enctype="multipart/form-data">
        <div class="form__row">
            ...
            <input class="form__input <?= $errors['name'] ? 'form__input--error' : ''?>" type="text" name="name" id="name" value="<?= $newTask['name'] ?? ''?>" placeholder="Введите название">
        ...
        <div class="form__row">
            ...
            <input class="form__input form__input--date" type="text" name="date" id="date"
                   placeholder="Введите дату и время" value="<?= $newTask['date'] ?? ''?>">
        ...
        <div class="form__row">
            ...
            <div class="form__input-file">
                <input class="visually-hidden" type="file" name="preview" id="preview" value="<?= $newTask['path'] ?? ''?>">
